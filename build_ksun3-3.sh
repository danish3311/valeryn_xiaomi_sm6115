...
KSU_VERSION="v3.3.0"
ZIPNAME=4.19-A16-valeryn-ksun-${KSU_VERSION}-`date +'%d.%m.%y-%H%M'`.zip
set -x
# Setup tools
...
# --- KernelSU-Next official install, pinned to v3.3.0 ---
rm -rf KernelSU-Next
curl -LSs "https://raw.githubusercontent.com/KernelSU-Next/KernelSU-Next/next/kernel/setup.sh" | bash -s "$KSU_VERSION" || exit 1
